...
class OrderSummaryComponent {
    ...
    public confirmOrder() {
        ...
        const confirmOrderButoon = this.rootElement.$('[name="confirm_order"]')
        confirmOrderButoon.waitForEnabled(null, null, 'The Confirm 0rder button is disabled.Check order details')
        confirmOrderButoon.click()
    }
}
